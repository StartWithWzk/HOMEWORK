...
public class MyService extends Service {
    ...
    public void onCreate() {
       ...
       /* try {
            socket = new Socket("192.168.199.56",9989);
            Log.d(TAG, "onCreate: 11111111111111111111111111111111111111111");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    class ServiceWay extends Binder {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    while (true) {
                     ...
                     /*       Log.d(TAG, "listen: aaaa");
                            InputStreamReader isr = new InputStreamReader(is);
                            Log.d(TAG, "listen: bbbbb");
                            BufferedReader br = new BufferedReader(isr);
                            Log.d(TAG, "listen: ccccc");
        ...
        public void log () {
            Log.d(TAG, "log: 6666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666");
        }
    }
}
